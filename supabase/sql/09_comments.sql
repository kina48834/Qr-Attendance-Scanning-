...
comment on column public.users.academic_track is 'junior_high | senior_high | college — set from Register.tsx / AdminUsers.tsx (button groups for school level & year in app). Rosters: JH (years 1–4 stored, UI Grade 7–10), SH (11–12), college (years 1–4 + program).';
