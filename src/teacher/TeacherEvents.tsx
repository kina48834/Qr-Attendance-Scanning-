  ...
  return (
    <div className="space-y-6">
      ...
      {sortedEvents.length > 0 && (
        <EventListSearchBar id="teacher-events-search" value={search} onChange={setSearch} className="max-w-xl" />
      )}
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-card overflow-hidden">
        ...
        {sortedEvents.length === 0 && (
          <div className="p-12 text-center text-slate-500">
            <p>No events yet.</p>
            <Link to="/teacher/events/new" className="mt-2 inline-block text-campus-primary font-medium hover:underline">
              Add event
            </Link>
          </div>
        )}
